 ...
 */
package io.github.dominikschlosser.k8store.realm;

import static io.github.dominikschlosser.k8store.spi.StoreInvalidation.REALM_AFTER_REMOVE;
import static io.github.dominikschlosser.k8store.spi.StoreInvalidation.REALM_BEFORE_REMOVE;

import io.github.dominikschlosser.k8store.crd.ClientInitialAccessSpec;
